...
import { fetchInterview } from "../../../states/actions/fetchInterview";
...
const Interview = () => {
  ...
  const data = useSelector((state) => state.fetchInterview.content);
  const isLoading = useSelector((state) => state.fetchInterview.isLoading);
